...
<html>
        ...
        <%DriverManager.registerDriver(new oracle.jdbc.driver.OracleDriver());
            ...
            while (rset.next()){
                ...
                if (CapturarFecha!=FechaActual) {

                    String CapturarHcomida = rset.getString(4);
                    String Substract2 = CapturarHcomida.substring(0,2);
                    ...
                    //DOLOR DE CABEZA NUMERO 2

                    //Primero colocar HorasTotales en 8
                    HorasTotales = 8;

                    //Captura hora de entrada y fechamin
                    String FechaMin = rset.getString(5);
                    fechaminima = fechaminima + "'" + FechaMin + "',";

                    //Capturar hora de comida
                    String CapturarHcomida = rset.getString(4);

                    if (CapturarHcomida == null) {
                        int x = Integer.parseInt(Substraer1) - Integer.parseInt(HoraActual.substring(0, 2));
                        ...
                        int x = Integer.parseInt(Substraer1) - Integer.parseInt(CapturarHcomida.substring(0, 2));
                        HorasTotales = HorasTotales - x;
                        conteo1 = conteo1 + Integer.toString(x) + ",";
                        comida = comida + 1 + ",";
                        int y = (Integer.parseInt(CapturarHcomida.substring(0, 2)) + 1) - Integer.parseInt(HoraActual.substring(0, 2));
